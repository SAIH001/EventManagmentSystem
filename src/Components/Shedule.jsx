        ...
        <div class="container">
            <div class="schedule-inner">
                <div class="schedule-title text-center mb-6 w-lg-60 mx-auto">
                    ...
                    <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec
                        ullamcorper
                                ...
                                <div class="schedule-list  text-center text-sm-start">
                                    <div
                                        ...
                                        <div class="schedule-box-title">
                                            <h5 class="mb-2"><a href="event-detail.html" class="black">REGISTRATION &
                                                    BREAKFAST</a></h5>
                                        </div>
                                        <div class="schedule-box-info">
                                            <p class="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing
                                                    elit. Ut elit tellus,
                                                    luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec
                                        ...
                                        <div class="schedule-box-bio d-md-flex">
                                            ...
                                            <div class="schedule-bio-info">
                                                <p class="mt-1 mb-0"><a href="speaker_detail.html" class="pink">JESUS
                                                        HOLLAND</a></p>
                                    ...
                                    <div
                                        class=" schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4">
                                        <div class="schedule-box-title">
                                            <h5 class="mb-2"><a href="event-detail.html" class="black">SPEED: MARKETING
                                                    MASTER!</a></h5>
                                        </div>
                                        <div class="schedule-box-info">
                                            <p class="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing
                                        ...
                                        <div class="schedule-box-bio d-md-flex">
                                            ...
                                            <div class="schedule-bio-info">
                                                <p class="mt-1 mb-0"><a href="speaker_detail.html" class="pink">NELSON
                                                        KETY</a></p>
                                                <small>Host & Speaker</small>
                                            </div>
                                        </div>
                                ...
                                <div class="schedule-list text-center text-sm-start">
                                    <div
                                        ...
                                        <div class="schedule-box-bio d-md-flex">
                                            ...
                                            <div class="schedule-bio-info">
                                                <p class="mt-1 mb-0"><a href="speaker_detail.html" class="pink">PEELRS
                                                        HELM</a></p>
                                                <small>Host & Speaker</small>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        class=" schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4 mb-5">
                                        <div class="schedule-box-title">
                                            <h5 class="mb-2"><a href="event-detail.html" class="black">EXPLORATIONS OF
                                                    NEW APPROACHES</a></h5>
                                        </div>
                                        <div class="schedule-box-info">
                                            <p class="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing
                                        ...
                                        <div class="schedule-box-bio d-md-flex">
                                            ...
                                            <div class="schedule-bio-info">
                                                <p class="mt-1 mb-0 pink"><a href="speaker_detail.html"
                                                        class="pink">JESUS HOLLAND</a></p>
                                                <small>Host & Speaker</small>
                                            </div>
                                        </div>
                                    </div>
