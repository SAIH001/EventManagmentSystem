...
import GroupOne from '../images/group/1.jpg'
import GroupTwo from '../images/group/2.jpg'
import GroupThree from '../images/group/3.jpg'
                                ...
                                <div class="col-lg-6 col-md-6 p-0 ">
                                    <div class="container-img-left mb-2">
                                        <div class="img-left-1 float-end w-lg-80">
                                            <img class="mb-2 w-100 rounded" src={GroupOne} alt="group-image"/>
                                        </div>
                                        <div class="img-left-2">
                                            <img src={GroupTwo} alt="group-image" class="w-100 rounded"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="container-img-right w-lg-75">
                                        <img src={GroupThree} alt="group-image" class="w-100 rounded"/>
                                    </div>
                                </div>
                            </div>
                        </div>
